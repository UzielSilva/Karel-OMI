...
public class Ventana2 extends JFrame {
    ...
    private VisorCodigo textPane2= new VisorCodigo(); 
    ...
    public Ventana2(){
        ...
        setTitle("KAREL OMI por Juan German Gonzalez Lopez");
       ...
       mtzamba.setPreferredSize(new Dimension(34,28));
        ...
        eSplitPane2.setDividerLocation(100);
        ...
        textPane.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyReleased(java.awt.event.KeyEvent evt) {
                textPane.pressed((evt.getKeyCode()==KeyEvent.VK_ENTER),false);
            }
        });
        textPane.setFont(new java.awt.Font("Monospaced", 0, 13)); 
    ...
    private void cCompila() {
        ...
        Compilador.built(textPane.getText());
        textPane.search(true);
